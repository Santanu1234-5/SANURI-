          ...
          {view === 'login' && (
            <>
              ...
              <Button 
                type="button" 
                variant="secondary" 
                className="w-full flex items-center justify-center gap-3 py-3.5 border-slate-700/50 bg-[#151A23] hover:bg-slate-800 transition-colors"
                onClick={() => {
                  if (onLogin) {
                    onLogin({ fullName: 'Google User', email: 'user@google.com' });
                  }
                }}
              >
